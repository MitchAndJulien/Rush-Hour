...
public class RushHourBoard extends InternetJButtonColor{
	...
	public void level0(){
		...
		int[][] a = new int[6][6];
		jams.add(a);
		ObjectiveCar car0 = new ObjectiveCar(2, 1, 1, jams.get(0), l);
	...
	public void level1(){
		...
		int[][] a = new int[6][6];
		jams.add(a);
		ObjectiveCar car0 = new ObjectiveCar(2, 0, 1, jams.get(1), l);		
	...
	public void level2(){
		...
		int[][] a = new int[6][6];
		jams.add(a);
		ObjectiveCar car0 = new ObjectiveCar(2, 1, 1, jams.get(2), l);
	...
	public void level3(){
		...
		ObjectiveCar car0 = new ObjectiveCar(2, 1, 1, jams.get(3), l);
	...
	public void level4(){
		...
		ObjectiveCar car0 = new ObjectiveCar(2, 1, 1, jams.get(4), l);
	...
	public void level5(){
		...
		ObjectiveCar car0 = new ObjectiveCar(2, 1, 1, jams.get(5), l);
	...
	public void level6(){
		...
		ObjectiveCar car0 = new ObjectiveCar(2, 1, 1, jams.get(6), l);
	...
	public void level7(){
		...
		ObjectiveCar car0 = new ObjectiveCar(2, 0, 1, jams.get(7), l);
	...
	public void level8(){
		...
		ObjectiveCar car0 = new ObjectiveCar(2, 0, 1, jams.get(8), l);
	...
	public void level9(){
		...
		ObjectiveCar car0 = new ObjectiveCar(2, 1, 1, jams.get(9), l);
